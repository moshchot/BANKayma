...
class AccountJournal(models.Model):
    ...
    sumit_type_entry = fields.Selection(
        ...
        help="Moves of type entry in this journal will create a document of the selected type "
        "in sumit",
    )
    sumit_type_out_invoice = fields.Selection(
        SUMIT_DOCUMENT_TYPE_SELECTION,
        string="Sumit type (customer invoice)",
        help="Customer invoices in this journal will create a document of the selected type "
        "in sumit",
    )
    sumit_type_out_refund = fields.Selection(
        SUMIT_DOCUMENT_TYPE_SELECTION,
        string="Sumit type (customer credit note)",
        help="Customer credit notes in this journal will create a document of the selected "
        "type in sumit",
    )
    ...
    sumit_type_in_refund = fields.Selection(
        ...
        help="Vendor credit notes in this journal will create a document of the selected type "
        "in sumit",
    )
    sumit_type_out_receipt = fields.Selection(
        SUMIT_DOCUMENT_TYPE_SELECTION,
        string="Sumit type (sales receipt)",
        help="Sales receipts in this journal will create a document of the selected type in "
        "sumit",
    )
    sumit_type_in_receipt = fields.Selection(
        SUMIT_DOCUMENT_TYPE_SELECTION,
        string="Sumit type (purchase receipt)",
        help="Purchase receipts in this journal will create a document of the selected type "
        "in sumit",
    )
