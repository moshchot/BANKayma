            ...
            def __init__(self, **_data):
                super().__init__(
                    (
                        ...
                        F(7, 5, "currency"),
                        F(8, 50, "details"),
                        F(9, 15, "left_account1"),
                        F(10, 15, "left_account2"),
                        F(11, 15, "right_account1"),
                        F(12, 15, "right_account2"),
                        F(13, 9, "left_account1_amount", float),
                        F(14, 9, "left_account2_amount", float),
                        F(15, 9, "right_account1_amount", float),
                        F(16, 9, "right_account2_amount", float),
                    ),
                    **_data
                )
